...
type
  ...
  TGLObject = class;
//  TGetGLObject = function: TGLObject; far;
...
// up, down
      ...
      //    glTranslatef(JitterPoints[jit].x * UnitPerPixel * Screen.ClientWidth * Jitter.Value /  10000,
      //      JitterPoints[jit].y * UnitPerPixel * Screen.ClientHeight * Jitter.Value / 10000, 0);
        end;
      for i:= 0 to ObjectCount - 1 do
        Objects[i].Paint;
      if Jitter.Enabled then
